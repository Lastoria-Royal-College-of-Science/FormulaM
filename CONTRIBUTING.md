...
Run the narrowest relevant check first while developing. Before opening a pull request that touches shared TypeScript, scientific logic, data loading, spectrum import/export, worker behavior, deployment configuration, or UI behavior, follow the full automated check order in [`.github/workflows/test.yml`](.github/workflows/test.yml).
