...
export const interactiveBorder = `enabled:active:border-accent enabled:focus:border-accent enabled:focus-visible:border-accent ${noNativeOutline}`;

export const blueButtonBorder = `enabled:active:border-accent enabled:focus-visible:border-accent ${noNativeOutline}`;
...
export const linkControlInteraction = `hover:[filter:var(--interactive-hover-filter)] active:[filter:var(--interactive-active-filter)] active:border-accent focus:border-accent focus-visible:border-accent active:shadow-control-glow focus-visible:shadow-control-glow ${noNativeOutline}`;
